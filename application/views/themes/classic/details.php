                            ...
                            <div class="product-price row m-0">
                                <h4 class="my-3">
                                    <?php if ($this->storecurrency->position == 1) {
                                        ...
                                        id="vpricedt"><?php echo $iteminfo->price; ?></span><?php if ($this->storecurrency->position == 2) {
                                              echo $this->storecurrency->curr_icon;
                                          } ?>
                                </h4>
                            </div>
                                ...
                                <select name="varientinfo" class="form-control" required id="varientinfodt"
                                    ...
                                    <?php foreach ($varientlist as $thisvarient) { ?>
                                        <option value="<?php echo $thisvarient->variantid; ?>"
                                            ...
                                            data-price="<?php echo $thisvarient->price; ?>" <?php if ($item->variantid == $thisvarient->variantid) {
                                                  echo "selected";
                                              } ?>>
                                                ...
                                                <div class="rating-block text-center">
                                                    ...
                                                    <div class="rating-point center-block">
                                                        ...
                                                        <h4 class="rating-count">
                                                            <?php echo number_format($average->averagerating, 1); ?>
                                                        </h4>
                                                    </div>
                                                        ...
                                                        if ($isgivenreview == 1) {
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="name" name="name"
                                                                    value="<?php if (!empty($customerinfo)) {
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="email" class="form-control" id="email" name="email"
                                                                    value="<?php if (!empty($customerinfo)) {
                                                                        echo $customerinfo->customer_email;
                                                                    } ?>"
                                                                    readonly="readonly" required>
                                                            </div>
                                                            <div class="form-group">
...
<script type="text/javascript"
    src="<?php echo base_url(); ?>application/views/themes/<?php echo $this->themeinfo->themename; ?>/assets_web/js/jquery.rateyo.js"></script>
<script
    src="<?php echo base_url(); ?>application/views/themes/<?php echo $this->themeinfo->themename; ?>/assets_web/js/details.js"></script>