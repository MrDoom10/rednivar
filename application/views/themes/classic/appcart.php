...
<head>
    ...
    <link href="<?php echo base_url(); ?>application/views/themes/<?php echo $acthemename; ?>/assets_web/css/style.css"
        rel="stylesheet">
    <link href="<?php echo base_url(); ?>application/views/themes/<?php echo $acthemename; ?>/assets_web/css/new.css"
        rel="stylesheet">
    <link
        href="<?php echo base_url(); ?>application/views/themes/<?php echo $acthemename; ?>/assets_web/css/responsive.css"
        rel="stylesheet">
    <script
        src="<?php echo base_url(); ?>application/views/themes/<?php echo $acthemename; ?>/assets_web/js/jquery-3.3.1.min.js"></script>
    <link
        href="<?php echo base_url(); ?>application/views/themes/<?php echo $acthemename; ?>/assets_web/css/appcart.css"
        rel="stylesheet">
...
<body>
            ...
            <div class="container-fluid">
                ...
                <nav id="sidebar" class="sidebar-nav">
                    ...
                    <ul class="metismenu list-unstyled" id="mobile-menu">
                        <li><a
                                href="<?php echo base_url() . 'app-terms'; ?>"><?php echo display('terms_condition') ?></a>
                        </li>
                        <li><a
                                href="<?php echo base_url() . 'app-refund-policty'; ?>"><?php echo display('refundp') ?></a>
                        </li>
                        <?php
                        if ($this->session->userdata('CusUserID') != "") { ?>
                            <li><a href="<?php echo base_url() . 'apporedrlist'; ?>"><?php echo display('morderlist') ?></a>
                            </li>
                        <?php } ?>
                    </ul>
                </nav>
    ...
    <section class="item_cart only-sm mt-4">
            ...
            <div class="row">
                ...
                <div class="col-12" id="mycartlist">
                        ...
                        <ul class="list-unstyled cart_list">
                                    ...
                                    <div class="d-flex">
                                        <div class="cart_counter d-flex">
                                            ...
                                            <input type="text" name="qty" id="sst3" maxlength="12"
                                                value="<?php echo $item['qty']; ?>" title="<?php echo display('qty') ?>:"
                                        ...
                                        <button class="btn dlt_btn" onclick="removetocart('<?php echo $item['rowid'] ?>')"><i
                            ...
                            <li>
                                ...
                                <p> <?php if (!empty($this->cart->contents())) {
                                    ...
                                    ?><input type="hidden" class="form-control" id="cartamount"
                                            value="<?php echo $totalamount + $calvat - $discount; ?>">
                    ...
                    <div class="form-group appcart_dispaly">
                        <input type="text" class="form-control app_cart_redius" id="couponcode" name="couponcode"
                            placeholder="<?php echo display('enter_coupon_code') ?>" required autocomplete="off">
        ...
        <input type="hidden" readonly class="form-control-plaintext text-right" id="table"
            value="<?php echo $this->session->userdata('tableid'); ?>">
        <div class="row m-0">
            <div class="col-12">
                <div class="form-group row m-0 align-items-center justify-content-between">
                    <h6 class="app_cart_h3"><?php echo display('table') ?>:
                        <?php echo $this->session->userdata('tableid'); ?></h6>
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" id="grandtotal" name="grandtotal"
                        value="<?php echo $totalamount + $calvat + $servicecharge - ($discount + $coupon); ?>">
                </div>
            </div>
        </div>
        <div class="row m-0">
                ...
                <div class="check_order appcart_order_check">
                        ...
                        <?php if (!empty($shippinginfo)) {
                            ...
                            foreach ($shippinginfo as $payment) {
                                ...
                                <div class="payment-item t-radio">
                                    <input type="radio" name="card_type" id="payment_method_cre<?php echo $p; ?>"
                                        data-parent="#payment" data-target="#description_cre<?php echo $p; ?>"
                                        value="<?php echo $payment->payment_method_id; ?>" <?php if ($payment->payment_method_id == 4) {
                                               echo "checked";
                                           } ?> class="">
                                    <label for="payment_method_cre<?php echo $p; ?>"> <?php echo $payment->payment_method; ?>
                                    </label>
                                </div>
                            <?php }
                        } ?>
                    ...
                    <div class="fixed_area only-sm appcart_order_padding">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-12">
                                    <button class="btn btn-success btn-block appcart_b" name="" type="submit"><img
                                            src="<?php echo base_url(); ?>assets/img/online-order.png" alt=""
                                            width="20"> <?php echo display('placeorder') ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script
        src="<?php echo base_url(); ?>application/views/themes/<?php echo $acthemename; ?>/assets_web/plugins/bootstrap-4.1.3-dist/js/bootstrap.min.js"></script>
    <script
        src="<?php echo base_url(); ?>application/views/themes/<?php echo $acthemename; ?>/assets_web/plugins/owl-carousel/owl.carousel.min.js"></script>
    <script
        src="<?php echo base_url(); ?>application/views/themes/<?php echo $acthemename; ?>/assets_web/plugins/metismenu/metisMenu.min.js"></script>
    <script
        src="<?php echo base_url(); ?>application/views/themes/<?php echo $acthemename; ?>/assets_web/plugins/wow/wow.min.js"></script>
    <script
        src="<?php echo base_url(); ?>application/views/themes/<?php echo $acthemename; ?>/assets_web/plugins/bootstrap-datepicker/bootstrap-datepicker.min.js"></script>
    <script
        src="<?php echo base_url(); ?>application/views/themes/<?php echo $acthemename; ?>/assets_web/plugins/clockpicker/clockpicker.min.js"></script>

    <!--===== ACTIVE JS=====-->
    <script
        src="<?php echo base_url(); ?>application/views/themes/<?php echo $acthemename; ?>/assets_web/js/custom.js"></script>

    <script
        src="<?php echo base_url(); ?>application/views/themes/<?php echo $acthemename; ?>/assets_web/js/returnpolicyqr.js"></script>
</body>
