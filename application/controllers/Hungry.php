...
class Hungry extends CI_Controller
{
	...
	{
		$data['title'] = "Services";  // Optional: add title or any data
		$data['seoterm'] = "services";

		// Load services content inside theme folder views, capture as string
		$data['content'] = $this->load->view('themes/' . $this->themeinfo->themename . '/services', $data, TRUE);

		// Load main index template passing the content
