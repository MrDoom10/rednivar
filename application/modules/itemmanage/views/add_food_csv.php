                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group row">
                                    <label for="suppliername"
                                        class="col-sm-4 col-form-label"><?php echo display('supplier_name') ?> *</label>
                                    <div class="col-sm-8">
...
<div class="row">
    <div class="col-sm-12 col-md-12">
        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                <a href="<?php echo base_url('assets/data/csv/product_csv_sample.csv') ?>"
                    class="btn btn-primary pull-right"><i class="fa fa-download"></i>
                    <?php echo display('download_sample_file') ?>
                </a>
                <span class="text-warning">The first line in downloaded csv file should remain as it is. Please do not
                    change the order of columns.</span><br>The correct column order is <span
                    class="text-info">(supplier_id, category_id, product_name, price, supplier_price, unit,
                    product_model, product_details, image_thumb, brand_id, variants, type, best_sale, onsale,
                    onsale_price, invoice_details, image_large_details,review, description, tag, specification, status
                    separated by vertical bar)</span> &amp; you must follow this.<br>Please make sure the csv file is
                UTF-8 encoded and not saved with byte order mark (BOM).<p>The images should be uploaded in <strong>For
                        thumb image: <?php echo base_url('my-assets/image/product/thumb') ?></strong> And for details
                    image: <strong><?php echo base_url('my-assets/image/product') ?></strong> folder.</p>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="col-sm-8">
                        <div class="form-group row">
                            <label for="upload_csv_file"
                                class="col-sm-3 col-form-label"><?php echo display('upload_csv_file') ?> <i
                                    class="text-danger">*</i></label>
                            <div class="col-sm-7">
                                <input class="form-control" name="upload_csv_file" type="file" id="upload_csv_file"
