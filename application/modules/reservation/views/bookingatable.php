    ...
    <div class="panel panel-default thumbnail">
      ...
      <div class="panel-body">
        <div class="table_content table_contentpost">
          <div class="table_content_booking"> <span
              class="table_booking_header"><?php echo display('bookatable'); ?></span>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <div class="input__holder3">
                        <input id="time" name="time" type="text" class="form-control timepicker"
                          placeholder="<?php echo display('seat_time'); ?>" readonly="readonly">
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <div class="input__holder3">
                        <input id="people" name="people" type="text" class="form-control"
                          placeholder="<?php echo display('no_of_people'); ?>">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <div class="input__holder3">
                        ...
                        <input type="button" class="btn btn-success" onclick="checkavail()"
